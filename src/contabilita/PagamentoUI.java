...
public class PagamentoUI implements ListSelectionListener {
	...
	private void initialize() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (check == 0) {
					JOptionPane.showMessageDialog(null,
							"Errore! Non puoi calcolare il conto del seguente cliente poichè sta ancora soggiornando");
					return;
				}
		...
		// Se il codice è presente in lista il pagamento va a buon fine altrimenti
		// messaggio di errore
		...
		HashMap<String, Cliente> clienti = DAOFactory.getDAOCliente().doRetrieveClientiPrenotati();
