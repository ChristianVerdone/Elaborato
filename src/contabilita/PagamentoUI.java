		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(contanti<contoTotale) {
					JOptionPane.showMessageDialog(null, "L'importo inserito non � valido, riprova", "Errore",JOptionPane.ERROR_MESSAGE);
				}else {
					JOptionPane.showMessageDialog(null, "Il pagamento � andato a buon fine");
		...
		btnPage.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(codiceCarta.length()!=16) {
					JOptionPane.showMessageDialog(null, "Il numero della carta � sbagliato riprova", "Errore",JOptionPane.ERROR_MESSAGE);
				}else {
					JOptionPane.showMessageDialog(null, "Il pagamento � andato a buon fine");
					ContoTotale ct= new ContoTotale(id,(Double.parseDouble(fieldConto.getText())),LocalDate.now(),textCodiceFiscale.getText()); 
					System.out.println(ct.toString());	
