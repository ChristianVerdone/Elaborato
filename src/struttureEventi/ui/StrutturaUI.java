...
public class StrutturaUI extends JFrame implements ActionListener {
	...
	public StrutturaUI() {
		...
		scrollPane_table_1.setBounds(169, 166, 291, 89);
		...
		scrollPane_table_Tessere.setBounds(169, 276, 291, 87);
