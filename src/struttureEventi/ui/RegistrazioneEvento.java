...
public class RegistrazioneEvento extends JFrame implements ActionListener{
	...
	public RegistrazioneEvento() {
		...
		lblNewLabel_4.setBounds(424, 216, 46, 14);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "registra":
			...
			dataEvento= LocalDateTime.of(data.getYear(), data.getMonth(), data.getDayOfMonth(), oraSpinner.getHours(), oraSpinner.getMinutes());
	   ...
	   if(DAOFactory.getDAOEvento().doRetrieveById(id)!=null) {
			JOptionPane.showMessageDialog(this, "Evento con identificativo " + id + "gi� registrato");
			break;}
